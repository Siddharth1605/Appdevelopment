...
import Doctor from "../Assets/women_doctor2.jpg";
  ...
  return (
    <div className="ba-section">
      <div className="ba-image-content">
        <img src={Doctor} alt="Doctor Group" className="ba-image1" style={{borderRadius: '25%'}} />
      </div>

      <div className="ba-text-content">
        <h3 className="ba-title">
          <span style={{color:'#B6EADA'}}>Why Choose Mr.Medico</span>
        </h3>
        ...
        <p className="ba-checks ba-check-first" style={{ color: '#B6EADA',
        fontSize: 22}}>
          <FontAwesomeIcon icon={faCircleCheck} style={{ color: "#1E8FFD" }} /> Best Professional Doctors
        </p>
        <p className="ba-checks" style={{ color: '#B6EADA',
        fontSize: 22}}>
        ...
        <p className="ba-checks ba-check-last" style={{ color: '#B6EADA',
        fontSize: 22}}>
